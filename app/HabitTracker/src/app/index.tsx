...
import type { DailyScore, HabitIndicator, HabitType } from '@/types/habits';

// Datos de perfil
const PROFILE = {
  name: 'Luis',
  initials: 'LL',
  edition: 'Luis Lecumberri',
};

const INDICATOR_INFO: { id: HabitType; name: string; unit: string; icon: string }[] = [
...
function getIndicators(record: ReturnType<typeof useDailyHabits>['record']): HabitIndicator[] {
  const values = {
